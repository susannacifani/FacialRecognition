...
if __name__ == '__main__':
    #reports_to_txt("output_files_25", "file_normalizzato.csv", "25fps_rf", toScale=True, resampled=False)
    reports_to_txt("output_files_50", "file_normalizzato.csv", "50fps_rf", toScale=True, resampled=False)
